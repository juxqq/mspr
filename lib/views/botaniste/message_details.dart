...
class BotanistMessagesDetails extends StatefulWidget {
  const BotanistMessagesDetails({Key? key}) : super(key: key);

  @override
  _BotanistMessagesDetailsState createState() => _BotanistMessagesDetailsState();
}

class _BotanistMessagesDetailsState extends State<BotanistMessagesDetails> {
