...
class BotanistThread extends StatefulWidget {
  const BotanistThread({Key? key}) : super(key: key);

  @override
  _BotanistThreadState createState() => _BotanistThreadState();
}

class _BotanistThreadState extends State<BotanistThread> {
  ...
  Post post = Post(
      ...
      DateTime(2002, 5, 17, 10, 30, 0));
  User user2 = User(1, "Thierry", "Henry", "test@gmail.com", "test", "test", 34290,
      "test", "assets/img/profilepic.png", true);
  User user1 = User(2, "Osaka", "Akiyuki", "osaka@gmail.com", "test", "test", 34290,
      "test",  "", false);
